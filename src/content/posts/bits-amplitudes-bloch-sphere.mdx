...
The angle θ here is the same one that will appear in the Bloch sphere parametrization — it encodes the relative weight between |0⟩ and |1⟩. The full picture adds a second angle φ for phase, which lives on a dimension the circle above cannot show. That is the Bloch sphere.

<div class="concept-map">
  <p class="concept-map-heading">What this post formalizes</p>
  <ul class="concept-map-list">
    <li><strong>Amplitudes:</strong> the complex numbers that encode a qubit's state, and why they aren't ordinary probabilities</li>
    <li><strong>Superposition:</strong> what it precisely means for a qubit to be "between" 0 and 1</li>
    <li><strong>Bra-ket notation:</strong> the compact shorthand physicists use for quantum states and inner products</li>
    <li><strong>The Bloch sphere:</strong> the geometry that maps every possible qubit state to a point on a sphere</li>
    <li><strong>Phase:</strong> the hidden coordinate invisible at measurement, which quantum algorithms exploit through interference</li>
  </ul>
</div>
