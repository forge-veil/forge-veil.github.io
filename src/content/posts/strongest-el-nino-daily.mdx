...
The second term is the long-term average temperature for that spot on that day of the year, taken here over 1971 to 2000. This baseline has a name: the [**climatology**](https://www.ncei.noaa.gov/products/optimum-interpolation-sst). Subtract it and the seasonal cycle drops out, leaving the departure from normal. The red tongue on the map is that anomaly, not the raw temperature, and it is the view that brings El Niño into focus.
