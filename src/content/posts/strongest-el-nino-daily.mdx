...
The second term is the **climatology**, a long-term average for each location and day, taken here over 1971 to 2000. Subtract it and the seasonal cycle drops out, leaving only the departure from normal. The red tongue on the map is the anomaly, not the temperature, and it is the only view where El Niño shows up at all.
